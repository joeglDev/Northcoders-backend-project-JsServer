...
const { getAllTopics, getArticleById, patchArticleById, getAllUsers, getAllArticles, getCommentsByArticleId, postCommentsByArticleId, deleteCommentById} = require(`${__dirname}/controllers/controllers.js`);
